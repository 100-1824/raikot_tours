<?php
/**
 * The template for displaying tour archives with migrated data fallback
 *
...
<div class="page-hero bg-[#1a2e44] py-32 relative overflow-hidden">
    <div class="container mx-auto px-4 relative z-10 text-center">
        <h1 class="text-5xl md:text-6xl font-bold text-white mb-4" data-aos="fade-up"><?php post_type_archive_title(); ?></h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        <?php if ( have_posts() ) : ?>
            <?php while ( have_posts() ) : the_post(); 
                ...
                render_archive_tour_card($tour_data);
            endwhile; ?>
 ...
 */
function render_archive_tour_card($tour) {
    ?>
