...
<section class="cluster-carousel-section py-32 bg-gradient-to-b from-luxury-navy via-luxury-navy to-luxury-navy text-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10">
        <!-- Section Header -->
        <div class="mb-24 max-w-2xl" data-aos="fade-up">
            <span class="text-luxury-gold font-bold uppercase tracking-[0.4em] text-[11px] mb-6 block">
                <?php _e( 'The Raikot Signature', 'raikot-tours' ); ?>
            </span>
            <h2 class="font-playfair text-5xl md:text-7xl font-bold mb-8 leading-tight">
                <?php _e( 'Navigating With Elegance', 'raikot-tours' ); ?>
            </h2>
            <div class="w-24 h-[2px] bg-luxury-gold mb-8"></div>
            <p class="text-white/60 text-xl font-light leading-relaxed max-w-xl">
                <?php _e( 'We believe that traversing the rugged beauty of Pakistan shouldn\'t mean compromising on comfort or safety. Every detail of your journey is orchestrated with surgical precision and nomadic soul.', 'raikot-tours' ); ?>
            </p>
        </div>
